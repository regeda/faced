...
func NewFaceDetectionAppAPI(spec *loads.Document) *FaceDetectionAppAPI {
	return &FaceDetectionAppAPI{
		...
		GetFacesHandler: GetFacesHandlerFunc(func(params GetFacesParams) middleware.Responder {
			return middleware.NotImplemented("operation GetFaces has not yet been implemented")
		}),
	}
}
...
func (o *FaceDetectionAppAPI) Validate() error {
	...
	if o.GetFacesHandler == nil {
		unregistered = append(unregistered, "GetFacesHandler")
	}
...
func (o *FaceDetectionAppAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/faces"] = NewGetFaces(o.context, o.GetFacesHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *FaceDetectionAppAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
